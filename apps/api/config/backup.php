...
$backupDisks = array_values(array_filter(
    array_map('trim', explode(',', (string) env('BACKUP_DISKS', 'local')))
));

$backupDisks = $backupDisks === [] ? ['local'] : $backupDisks;
$backupArchivePassword = env('BACKUP_ARCHIVE_PASSWORD');
$backupArchivePassword = $backupArchivePassword === '' ? null : $backupArchivePassword;
$backupMaximumAgeInDays = (int) env('BACKUP_MAX_AGE_DAYS', 1);
$backupMaximumStorageInMegabytes = (int) env('BACKUP_MAX_STORAGE_MB', 5000);
...
return [
    ...
    'backup' => [
         ...
         */
        'password' => $backupArchivePassword,
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFICATION_EMAIL', env('MAIL_FROM_ADDRESS', 'ops@talabix.test')),
    ...
    'monitor_backups' => [
        [
            ...
            'disks' => $backupDisks,
            'health_checks' => [
                MaximumAgeInDays::class => $backupMaximumAgeInDays,
                MaximumStorageInMegabytes::class => $backupMaximumStorageInMegabytes,
            ],
        ],
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
             ...
             */
            'delete_oldest_backups_when_using_more_megabytes_than' => (int) env('BACKUP_DELETE_OLDEST_WHEN_USING_MORE_MB', 5000),
        ],
