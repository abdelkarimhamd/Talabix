...
export const translations = {
  en: {
    ...
    portal: {
      ...
      roleSwitcher: 'Workspace role',
      searchLabel: 'Search portal',
      searchPlaceholder: 'Search orders, merchants, or users...',
      ...
      switchToSuperSession: 'Switch to super admin workspace',
    ...
    ops: {
      ...
      configuration: {
        defaults: {
          ...
          city: 'Riyadh',
          zoneName: 'Primary delivery zone',
        },
        setup: {
          eyebrow: 'Store setup',
          title: 'Store and first branch',
        },
        fields: {
          ...
          serviceZoneName: 'Service zone name',
          deliveryRadiusMeters: 'Delivery radius meters',
          deliveryFeeMinorUnits: 'Delivery fee minor units',
          mapsProvider: 'Maps provider',
          googleMapsApiKey: 'Google Maps API key',
          googleMapsRegion: 'Google Maps region',
          locationBias: 'Location bias',
          googleMapsLocationBias: 'Google Maps location bias',
          timeoutSeconds: 'Timeout seconds',
          googleMapsTimeoutSeconds: 'Google Maps timeout seconds',
          googleMapsFallback: 'Google Maps fallback to demo',
          clearStoredMapsKey: 'Clear stored maps key',
          merchantStatus: 'Merchant status',
          merchantConfigurationStatus: 'Merchant configuration status',
          platformCommissionBps: 'Platform commission (bps)',
          merchantPlatformCommissionBps: 'Merchant platform commission bps',
          branchStatus: 'Branch status',
          branchConfigurationStatus: 'Branch configuration status',
          branchAcceptsOrders: 'Branch accepts orders',
          serviceZoneCity: 'Service zone city',
          postalCode: 'Postal code',
          serviceZonePostalCode: 'Service zone postal code',
          centerLatitude: 'Center latitude',
          serviceZoneCenterLatitude: 'Service zone center latitude',
          centerLongitude: 'Center longitude',
          serviceZoneCenterLongitude: 'Service zone center longitude',
          radiusMeters: 'Radius meters',
          serviceZoneRadiusMeters: 'Service zone radius meters',
          serviceZoneActive: 'Service zone active',
          feeBandMinDistance: 'Fee band min distance',
          feeBandMinimumDistanceMeters: 'Fee band minimum distance meters',
          feeBandMaxDistance: 'Fee band max distance',
          feeBandMaximumDistanceMeters: 'Fee band maximum distance meters',
          feeAmountMinor: 'Fee amount (minor)',
          feeBandFeeMinor: 'Fee band fee minor',
        },
        actions: {
          creatingStore: 'Creating store...',
          createStore: 'Create store',
          cancel: 'Cancel',
          hideStoreForm: 'Hide store form',
          addStore: 'Add store',
          saveMapsProvider: 'Save maps provider configuration',
          saveMerchant: 'Save merchant configuration',
          saveBranch: 'Save branch configuration',
          editZone: 'Edit zone',
          saveServiceZone: 'Save service zone',
          createServiceZone: 'Create service zone',
          newZone: 'New zone',
          editFeeBand: 'Edit fee band',
        ...
        feedback: {
          ...
          branchSaveFailed: 'Branch configuration could not be saved.',
          serviceZoneSaved: '{zone} service zone saved.',
          serviceZoneSaveFailed: 'Service zone could not be saved.',
          feeBandSaved: 'Fee band {min}-{max} meters saved.',
          feeBandSaveFailed: 'Fee band could not be saved.',
        },
        empty: {
        ...
        maps: {
          eyebrow: 'Maps provider',
          title: 'Google Maps provider',
          configuredViaAdmin: 'Configured via admin',
          configuredViaEnvironment: 'Configured via environment',
          apiKeyNotConfigured: 'API key not configured',
          provider: 'Provider',
          keyPreview: 'Key preview',
          runtime: 'Runtime',
          notStored: 'Not stored',
          loading: 'Loading maps configuration.',
          providerGoogleMaps: 'Google Maps',
          providerDemo: 'Demo',
          apiKeyPlaceholder: 'Paste key when ready',
          useDemoFallback: 'Use demo fallback when Google Maps fails',
          clearStoredApiKey: 'Clear stored API key',
          runtimeGoogleReady: 'Google Maps is ready for live traffic.',
          runtimeDemoActive: 'Demo maps provider is active.',
          runtimeFallback:
            'Google Maps is selected and will use demo fallback until an API key is configured.',
        },
        counts: {
          merchants: '{count} merchant',
          merchants_plural: '{count} merchants',
          activeZoneEntries: '{count} active zone entry',
          activeZoneEntries_plural: '{count} active zone entries',
          feeBands: '{count} fee band',
          feeBands_plural: '{count} fee bands',
          zones: '{count} zone',
          zones_plural: '{count} zones',
          bands: '{count} band',
          bands_plural: '{count} bands',
        },
        scope: {
          eyebrow: 'Scope',
          selectMerchant: 'Select merchant',
          selectMerchantConfiguration: 'Select merchant configuration',
          selectBranch: 'Select branch',
          selectBranchConfiguration: 'Select branch configuration',
        ...
        rules: {
          ...
          currentRulesText:
            '{zones} and {bands} shape this branch’s delivery coverage.',
        },
        merchant: {
          eyebrow: 'Merchant commission',
          financeDefaultsFor: 'Finance defaults for {merchant}',
        },
        branch: {
          eyebrow: 'Branch controls',
          acceptOrders: 'Accept orders for this branch',
        },
        zones: {
          eyebrow: 'Service zones',
          title: 'Delivery coverage for {branch}',
          meters: '{count} meters',
          zoneIsActive: 'Zone is active',
        },
        fees: {
          eyebrow: 'Fee bands',
          title: 'Distance-based delivery pricing',
          distance: 'Distance',
          distanceRange: '{min}-{max}m',
        },
      },
      accountSecurity: {
  ...
  ar: {
    ...
    portal: {
      ...
      roleSwitcher: 'دور مساحة العمل',
      searchLabel: 'البحث في البوابة',
      searchPlaceholder: 'ابحث عن الطلبات أو المتاجر أو المستخدمين...',
      ...
      switchToSuperSession: 'التبديل إلى مساحة المشرف',
    ...
    ops: {
      ...
      configuration: {
        defaults: {
          ...
          city: 'الرياض',
          zoneName: 'نطاق التوصيل الأساسي',
        },
        setup: {
          eyebrow: 'إعداد المتجر',
          title: 'المتجر والفرع الأول',
        },
        fields: {
          ...
          serviceZoneName: 'اسم نطاق الخدمة',
          deliveryRadiusMeters: 'نطاق التوصيل بالمتر',
          deliveryFeeMinorUnits: 'رسوم التوصيل بالوحدات الصغرى',
          mapsProvider: 'مزود الخرائط',
          googleMapsApiKey: 'مفتاح Google Maps API',
          googleMapsRegion: 'منطقة Google Maps',
          locationBias: 'انحياز الموقع',
          googleMapsLocationBias: 'انحياز موقع Google Maps',
          timeoutSeconds: 'مهلة الانتظار بالثواني',
          googleMapsTimeoutSeconds: 'مهلة Google Maps بالثواني',
          googleMapsFallback: 'الرجوع إلى التجريبي عند تعطل Google Maps',
          clearStoredMapsKey: 'حذف مفتاح الخرائط المحفوظ',
          merchantStatus: 'حالة المتجر',
          merchantConfigurationStatus: 'حالة إعداد المتجر',
          platformCommissionBps: 'عمولة المنصة (نقاط أساس)',
          merchantPlatformCommissionBps: 'عمولة منصة المتجر بالنقاط',
          branchStatus: 'حالة الفرع',
          branchConfigurationStatus: 'حالة إعداد الفرع',
          branchAcceptsOrders: 'الفرع يقبل الطلبات',
          serviceZoneCity: 'مدينة نطاق الخدمة',
          postalCode: 'الرمز البريدي',
          serviceZonePostalCode: 'الرمز البريدي لنطاق الخدمة',
          centerLatitude: 'خط عرض المركز',
          serviceZoneCenterLatitude: 'خط عرض مركز نطاق الخدمة',
          centerLongitude: 'خط طول المركز',
          serviceZoneCenterLongitude: 'خط طول مركز نطاق الخدمة',
          radiusMeters: 'نصف القطر بالمتر',
          serviceZoneRadiusMeters: 'نصف قطر نطاق الخدمة بالمتر',
          serviceZoneActive: 'نطاق الخدمة نشط',
          feeBandMinDistance: 'أقل مسافة لشريحة الرسوم',
          feeBandMinimumDistanceMeters: 'أقل مسافة لشريحة الرسوم بالمتر',
          feeBandMaxDistance: 'أعلى مسافة لشريحة الرسوم',
          feeBandMaximumDistanceMeters: 'أعلى مسافة لشريحة الرسوم بالمتر',
          feeAmountMinor: 'مبلغ الرسوم (وحدة صغرى)',
          feeBandFeeMinor: 'مبلغ شريحة الرسوم بالوحدات الصغرى',
        },
        actions: {
          creatingStore: 'جار إنشاء المتجر...',
          createStore: 'إنشاء المتجر',
          cancel: 'إلغاء',
          hideStoreForm: 'إخفاء نموذج المتجر',
          addStore: 'إضافة متجر',
          saveMapsProvider: 'حفظ إعدادات مزود الخرائط',
          saveMerchant: 'حفظ إعدادات المتجر',
          saveBranch: 'حفظ إعدادات الفرع',
          editZone: 'تعديل النطاق',
          saveServiceZone: 'حفظ نطاق الخدمة',
          createServiceZone: 'إنشاء نطاق خدمة',
          newZone: 'نطاق جديد',
          editFeeBand: 'تعديل شريحة الرسوم',
        ...
        feedback: {
          ...
          branchSaveFailed: 'تعذر حفظ إعدادات الفرع.',
          serviceZoneSaved: 'تم حفظ نطاق خدمة {zone}.',
          serviceZoneSaveFailed: 'تعذر حفظ نطاق الخدمة.',
          feeBandSaved: 'تم حفظ شريحة الرسوم من {min} إلى {max} متر.',
          feeBandSaveFailed: 'تعذر حفظ شريحة الرسوم.',
        },
        empty: {
          title: 'أنشئ أول متجر',
        ...
        page: {
          ...
          title:
            'التحكم في العمولات واستقبال طلبات الفروع ونطاقات الخدمة والرسوم',
        },
        maps: {
          eyebrow: 'مزود الخرائط',
          title: 'مزود Google Maps',
          configuredViaAdmin: 'تم الإعداد من الإدارة',
          configuredViaEnvironment: 'تم الإعداد من البيئة',
          apiKeyNotConfigured: 'مفتاح API غير معد',
          provider: 'المزود',
          keyPreview: 'معاينة المفتاح',
          runtime: 'التشغيل',
          notStored: 'غير محفوظ',
          loading: 'جار تحميل إعدادات الخرائط.',
          providerGoogleMaps: 'Google Maps',
          providerDemo: 'تجريبي',
          apiKeyPlaceholder: 'الصق المفتاح عند جاهزيته',
          useDemoFallback: 'استخدم التقدير التجريبي عند تعطل Google Maps',
          clearStoredApiKey: 'حذف مفتاح API المحفوظ',
          runtimeGoogleReady: 'Google Maps جاهز للطلبات الحية.',
          runtimeDemoActive: 'مزود الخرائط التجريبي نشط.',
          runtimeFallback:
            'تم اختيار Google Maps وسيستخدم التقدير التجريبي إلى أن يتم إعداد مفتاح API.',
        },
        counts: {
          merchants: '{count} متجر',
          merchants_plural: '{count} متجر',
          activeZoneEntries: '{count} نطاق نشط',
          activeZoneEntries_plural: '{count} نطاقات نشطة',
          feeBands: '{count} شريحة رسوم',
          feeBands_plural: '{count} شرائح رسوم',
          zones: '{count} نطاق',
          zones_plural: '{count} نطاقات',
          bands: '{count} شريحة',
          bands_plural: '{count} شرائح',
        },
        scope: {
          eyebrow: 'النطاق',
          selectMerchant: 'اختر المتجر',
          selectMerchantConfiguration: 'اختيار إعدادات المتجر',
          selectBranch: 'اختر الفرع',
          selectBranchConfiguration: 'اختيار إعدادات الفرع',
          commission: 'العمولة',
        ...
        rules: {
          ...
          currentRulesText: '{zones} و{bands} تحدد تغطية التوصيل لهذا الفرع.',
        },
        merchant: {
          eyebrow: 'عمولة المتجر',
          financeDefaultsFor: 'إعدادات مالية افتراضية لـ {merchant}',
        },
        branch: {
          eyebrow: 'تحكم الفرع',
          acceptOrders: 'قبول الطلبات لهذا الفرع',
        },
        zones: {
          eyebrow: 'نطاقات الخدمة',
          title: 'تغطية التوصيل لـ {branch}',
          meters: '{count} متر',
          zoneIsActive: 'النطاق نشط',
        },
        fees: {
          eyebrow: 'شرائح الرسوم',
          title: 'تسعير التوصيل حسب المسافة',
          distance: 'المسافة',
          distanceRange: '{min}-{max} م',
        },
      },
      accountSecurity: {
        eyebrow: 'أمان الحساب',
